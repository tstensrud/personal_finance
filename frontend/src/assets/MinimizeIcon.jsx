function MinimizeIcon ({ dimensions }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height={dimensions} viewBox="0 -960 960 960" width={dimensions} className="fill-light-grey group-hover:fill-primary-color cursor-pointer duration-200">
